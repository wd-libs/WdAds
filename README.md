...
~~~
    ...
    implementation 'com.github.quyenvnu:MKAds:1.0.8'
...
class App extends AdsMultiDexApplication(){
    ...
    public void onCreate() {
        super.onCreate();
    ...
        String environment = BuildConfig.build_debug ? MKAdConfig.ENVIRONMENT_DEVELOP : MKAdConfig.ENVIRONMENT_PRODUCTION;
