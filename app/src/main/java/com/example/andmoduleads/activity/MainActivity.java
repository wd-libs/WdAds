...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MKGAd.getInstance().setCountClickToShowAds(3);
        ...
        findViewById(R.id.btShowAds).setOnClickListener(v -> {
            if (mInterstitialAd.isReady()) {
                ...
                ApInterstitialAd inter = MKGAd.getInstance().getInterstitialAds(this, idInter, null);

                MKGAd.getInstance().showInterstitialAdByTimes(this, mInterstitialAd, new MKAdCallback() {
                    @Override
        ...
        findViewById(R.id.btForceShowAds).setOnClickListener(v -> {
            if (mInterstitialAd.isReady()) {
                MKGAd.getInstance().forceShowInterstitial(this, mInterstitialAd, new MKAdCallback() {
                    @Override
                    public void onNextAction() {
        ...
        findViewById(R.id.btnShowReward).setOnClickListener(v -> {
            if (rewardAd != null && rewardAd.isReady()) {
                MKGAd.getInstance().forceShowRewardAd(this, rewardAd, new MKAdCallback());
                return;
            }
            rewardAd = MKGAd.getInstance().getRewardAd(this,  BuildConfig.ad_reward, null);
        });
    ...
    private void loadAdInterstitial() {
        ...
        mInterstitialAd = MKGAd.getInstance().getInterstitialAds(this, idInter, null);
    }


    public void onTrackSimpleEventClick(View v) {
        MKAdjust.onTrackEvent(EVENT_TOKEN_SIMPLE);
    }

    public void onTrackRevenueEventClick(View v) {
        MKAdjust.onTrackRevenue(EVENT_TOKEN_REVENUE, 1f, "EUR");
    }
