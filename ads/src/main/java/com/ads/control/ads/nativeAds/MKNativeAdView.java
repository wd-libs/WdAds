...
public class MKNativeAdView extends RelativeLayout {
    ...
    public MKNativeAdView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public MKNativeAdView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }


    public MKNativeAdView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void populateNativeAdView(Activity activity, ApNativeAd nativeAd) {
        ...
        MKGAd.getInstance().populateNativeAdView(activity, nativeAd, layoutPlaceHolder, layoutLoading);
    }
    ...
    public void loadNativeAd(Activity activity, String idAd, MKAdCallback mkAdCallback) {
        ...
        MKGAd.getInstance().loadNativeAd(activity, idAd, layoutCustomNativeAd, layoutPlaceHolder, layoutLoading, mkAdCallback);
    }
