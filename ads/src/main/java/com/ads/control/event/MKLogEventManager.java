...
public class MKLogEventManager {
    ...
    public static void logPaidAdImpression(Context context, AdValue adValue, String adUnitId, String mediationAdapterClassName, AdType adType) {
        ...
        MKAdjust.pushTrackEventAdmob(adValue);
        MKAppsflyer.getInstance().pushTrackEventAdmob(adValue, adUnitId, adType);
...
//        logEventWithAds(context, (float) adValue.getRevenue(), 0, adValue.getAdUnitId(), adValue.getNetworkName(), MKAdConfig.PROVIDER_MAX);
        logEventWithMaxAds(context, adValue);
        MKAdjust.pushTrackEventApplovin(adValue, context);
        MKAppsflyer.getInstance().pushTrackEventApplovin(adValue, adType);
    }
    ...
    private static void logPaidAdImpressionValue(Context context, double value, int precision, String adunitid, String network, int mediationProvider) {
        ...
        MKAdjust.logPaidAdImpressionValue(value, "USD");
    ...
    public static void pushTrackEventApplovin(MaxAd ad, Context context) {
        MKAdjust.pushTrackEventApplovin(ad, context);
    }
}
